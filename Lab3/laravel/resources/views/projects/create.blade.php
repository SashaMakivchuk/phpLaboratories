    ...
    <form action="{{ route('projects.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" id="rating1" name="rating1" min="1" max="5" value="{{ old('rating1') }}" class="w-full p-3 border rounded" required>
            </div>
            <div>
                <label for="rating2" class="block text-sm font-medium">Рейтинг 2</label>
                <input type="number" id="rating2" name="rating2" min="1" max="5" value="{{ old('rating2') }}" class="w-full p-3 border rounded" required>
            </div>
            <div>
                <label for="rating3" class="block text-sm font-medium">Рейтинг 3</label>
                <input type="number" id="rating3" name="rating3" min="1" max="5" value="{{ old('rating3') }}" class="w-full p-3 border rounded" required>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('projects.index') }}" class="text-blue-500 hover:underline">Назад до списку проектів</a>
        </div>
    </form>
</div>
</body>
